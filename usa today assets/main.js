...
define(
    'app',[
        'jquery',
        'api/analytics',
        'http://www.gannett-cdn.com/experiments/usatoday/2016/quizzes/money/whats-your-fraud-iq/colorbox.js'
    ],
    function(jQuery, Analytics) {
        ...
        quiz.init = function() {
            ...
            var _lastStringInUrl = _currentUrl.substr(_currentUrl.length - 1);
            console.log('_lastStringInUrl = '+_lastStringInUrl);
            if (_lastStringInUrl != '/') {
            ...
            quiz.demoQ1A1 = jQuery(".q1-male");
            quiz.demoQ1A2 = jQuery(".q1-female");
            quiz.demoQ1A3 = jQuery(".q1-none");
            quiz.demoQ2A1 = jQuery(".q2-18-25");
            quiz.demoQ2A2 = jQuery(".q2-26-35");
            quiz.demoQ2A3 = jQuery(".q2-36-45");
            quiz.demoQ2A4 = jQuery(".q2-46-55");
            quiz.demoQ2A5 = jQuery(".q2-55u");
            quiz.demoQ2A6 = jQuery(".q2-none");
            ...
            jQuery.each(quiz.objData, function(index) {
                ...
                jQuery.each(quiz.objData[index].questions, function(qindex) {
                    ...
                    jQuery.each(quiz.objData[index].questions[qindex].answers, function(aindex) {
                        strHTMLQuizzes += '            <div class="answer q_id_' + quiz.objData[index].questions[qindex].q_id + '_' + aindex + '">';
                ...
                strHTMLQuizzes += '        <div class="social-buttons"> <a href="javascript:void(0)" class="social-link" id="twitter-share"> <img src="http://www.gannett-cdn.com/experiments/usatoday/2014/12/year-end-quiz/img/twitter.svg" alt="twitter" class="social-icon"></a>';
                strHTMLQuizzes += '        <a href="javascript:void(0)" class="social-link"><img src="http://www.gannett-cdn.com/experiments/usatoday/2014/12/year-end-quiz/img/fb.svg" alt="twitter" class="social-icon"></a>';
                strHTMLQuizzes += '        <a href="javascript:void(0)" class="social-link" id="email-share"><img src="http://www.gannett-cdn.com/experiments/usatoday/2014/12/year-end-quiz/img/email.svg" alt="email" class="social-icon"></a></div>';
        ...
        quiz.addEventListeners = function() {
            ...
            /* ================================================================================================================================ */
            /* EVENT LISTENER : DEMOGRAPHY QUESTION 1 : GENDER =============================================================================== */
            /* ================================================================================================================================ */
            
            quiz.demoQ1A1.click(function(e) {
                //load tracking pixel
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2823658S37020160503160417&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
            ...
            quiz.demoQ1A2.click(function(e) {
                //load tracking pixel
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2823659S98820160503160418&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                //proceed to question 2
                $(".q1").hide();
                $(".q2").fadeIn();
                $.colorbox.resize();
            ...
            quiz.demoQ1A3.click(function(e) {
                //load tracking pixel
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2823660M64220160503160419&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                //proceed to question 2
                $(".q1").hide();
                $(".q2").fadeIn();
                $.colorbox.resize();
            ...
            /* ================================================================================================================================ */
            /* EVENT LISTENER : DEMOGRAPHY QUESTION 2 : AGE ================================================================================== */
            /* ================================================================================================================================ */
            
            quiz.demoQ2A1.click(function(e) {
                //load tracking pixel
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2823661K39420160503160419&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                // close question 2
                $(".q2").hide();
                $.colorbox.close()
                return false;
            });
            quiz.demoQ2A2.click(function(e) {
                //load tracking pixel
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2823662I37120160503160419&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                // close question 2
                $(".q2").hide();
                $.colorbox.close()
                return false;
            });
            quiz.demoQ2A3.click(function(e) {
                //load tracking pixel
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2823663S50220160503160419&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                // close question 2
                $(".q2").hide();
                $.colorbox.close()
                return false;
            });
            quiz.demoQ2A4.click(function(e) {
                //load tracking pixel
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2823664U95520160503160420&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                // close question 2
                $(".q2").hide();
                $.colorbox.close()
                return false;
            });
            quiz.demoQ2A5.click(function(e) {
                //load tracking pixel
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2823665X61320160503160420&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                // close question 2
                $(".q2").hide();
                $.colorbox.close()
                return false;
            });
            quiz.demoQ2A6.click(function(e) {
                //load tracking pixel
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2823666P62320160503160421&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                // close question 2
                $(".q2").hide();
                $.colorbox.close()
                return false;
            ...
            /* ================================================================================================================================ */
            /* EVENT LISTENER : QUIZ QUESTION 1 =============================================================================================== */
            /* ================================================================================================================================ */
            jQuery(".q_id_1_0").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824092V48620160506190425&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_1_1").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824093X51420160506190425&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_1_2").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824094D98720160506190426&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            
            /* ================================================================================================================================ */
            /* EVENT LISTENER : QUIZ QUESTION 2 =============================================================================================== */
            /* ================================================================================================================================ */
            jQuery(".q_id_2_0").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824095L87620160506190426&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_2_1").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824096F16720160506190426&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_2_2").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824097L61320160506190427&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_2_3").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824098R63120160506190427&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_2_4").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824099V96220160506190427&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_2_5").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824100P99520160506190428&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            
            /* ================================================================================================================================ */
            /* EVENT LISTENER : QUIZ QUESTION 3 =============================================================================================== */
            /* ================================================================================================================================ */
            jQuery(".q_id_3_0").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824101H83520160506190428&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_3_1").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824102K56320160506190428&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            
            /* ================================================================================================================================ */
            /* EVENT LISTENER : QUIZ QUESTION 4 =============================================================================================== */
            /* ================================================================================================================================ */
            jQuery(".q_id_4_0").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824103R57020160506190429&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_4_1").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824104G37020160506190429&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_4_2").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824105E67620160506190429&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_4_3").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824106B28920160506190430&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_4_4").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824107K75420160506190430&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            
            /* ================================================================================================================================ */
            /* EVENT LISTENER : QUIZ QUESTION 5 =============================================================================================== */
            /* ================================================================================================================================ */
            jQuery(".q_id_5_0").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824108W68320160506190430&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_5_1").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824109G46620160506190430&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_5_2").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824110B53120160506190431&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            
            /* ================================================================================================================================ */
            /* EVENT LISTENER : QUIZ QUESTION 6 =============================================================================================== */
            /* ================================================================================================================================ */
            jQuery(".q_id_6_0").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824111I74620160506190431&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_6_1").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824112R70520160506190431&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_6_2").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824113N20420160506190432&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            
            /* ================================================================================================================================ */
            /* EVENT LISTENER : QUIZ QUESTION 7 =============================================================================================== */
            /* ================================================================================================================================ */
            jQuery(".q_id_7_0").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824114G77020160506190432&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_7_1").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824115B97220160506190432&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_7_2").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824116O01320160506190433&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_7_3").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824117R30320160506190433&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            
            /* ================================================================================================================================ */
            /* EVENT LISTENER : QUIZ QUESTION 8 =============================================================================================== */
            /* ================================================================================================================================ */
            jQuery(".q_id_8_0").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824118W47620160506190433&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_8_1").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824119P12820160506190434&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_8_2").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824120D58520160506190434&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_8_3").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824121H77120160506190434&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_8_4").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824122S26920160506190435&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_8_5").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824123Y66720160506190435&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            
            /* ================================================================================================================================ */
            /* EVENT LISTENER : QUIZ QUESTION 9 =============================================================================================== */
            /* ================================================================================================================================ */
            jQuery(".q_id_9_0").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824124N01920160506190435&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_9_1").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824125C40420160506190436&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
            jQuery(".q_id_9_2").click(function(e) {
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824422X89320160509164354&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                return false;
            });
        ...
        quiz.startQuiz = function() {
            ...
            strShareHead = strShareHead.replace(/'/g, "\\'");
            strShareChatter = strShareChatter.replace(/'/g, "\\'");
        ...
        quiz.renderResults = function() {
            ...
            quiz.arrQuizResults.eq(quiz.currentQuiz).append('<div class="quiz-legal">*Information collected will be used pursuant to USA Today\'s <a href="http://static.usatoday.com/privacy/" target="_blank">Privacy Policy</a></div>');
            ...
            /* ================================================================================================================================ */
            /* EVENT LISTENER : RESULTS PAGE ================================================================================================== */
            /* ================================================================================================================================ */
            jQuery(".results-panel .results-low").click(function(e) {
                console.log('.results-low');
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824128A24820160506190437&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                //return false;
            });
            jQuery(".results-panel .results-medium").click(function(e) {
                console.log('.results-medium');
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824127L31620160506190437&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                //return false;
            });
            jQuery(".results-panel .results-high").click(function(e) {
                console.log('.results-high');
                $("<img src='http://ads.pointroll.com/PortalServe/?pid=2824126U88220160506190436&pos=i&r=" + new Date().getTime() + "' />").load(function () {});
                //return false;
            });
        };
        ...
        quiz.loadDemoQuestions = function() {
          $.colorbox({opacity:"0", width:"80%", inline:true, href:"#inline_content_q1"});
        };
        return quiz;
    });
